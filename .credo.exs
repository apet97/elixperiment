  ...
  configs: [
    %{
      ...
      files: %{
        ...
        #
        # Every Elixir source this repository owns. `priv/repo/` is included so
        # that migrations are held to the same standard as application code.
      ...
      #
      requires: ["credo/no_web_layer_repo.ex"],
      #
