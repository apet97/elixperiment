...
The latest bounded live reads on the clean candidate named by the receipt
returned HTTP 200 with the
...
request. The redacted receipt is `tmp/live_api_preflight_receipt.json`. The
script SHA-256 was
